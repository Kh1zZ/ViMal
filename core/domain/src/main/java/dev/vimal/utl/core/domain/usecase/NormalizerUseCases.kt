...
/**
 * Orchestrates the full audio normalization and video compression pipeline.
...
class NormalizeVideoUseCase(private val repository: NormalizerRepository) {
    ...
    operator fun invoke(
        ...
        return repository.normalize(context, source, preset, customTargetLufs, resolutionPreset)
    }
}
